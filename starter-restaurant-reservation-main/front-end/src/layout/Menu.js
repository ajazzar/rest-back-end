      ...
      <div className="w-full text-xl">
        ...
        <ul className="text-light">
          <li className="hover:bg-gray-700 px-2 rounded-xl">
            <Link
              className="block hover:text-white-500 hover:no-underline py-2 transition duration-200"
              to="/dashboard"
            >
          ...
          <li className="hover:bg-gray-700 px-2 rounded-xl">
            <Link
              class="no-underline block hover:text-white-500 hover:no-underline py-2 transition duration-200"
              to="/search"
            >
