...
export default function Table({ table, index }) {
  ...
  return (
    <div className="flex flex-row justify-center items-center drop-shadow-3xl mx-auto text-center w-8/12 sm:w-4/12 text-xl font-bold leading-10 text-gray-100 p-4 rounded-3xl">
      <div key={index}>
        ...
        {table.reservation_id && (
          <button
            className="focus:outline-none bg-gray-100 hover:bg-teal-600 hover:text-black font-bold py-1 px-3 my-2 rounded-full"
            type="submit"
